...
`EPIC-STOREFRONT-ACADEMIC-PHASE-1` está en estado `DEFINED / COORDINATION ONLY`. Esta agrupación documental consume los roadmap items 09-13 sin renombrarlos, mantiene SPEC-007 pausada y SPEC-008 reservada para Fake WhatsApp. SPEC-009 completó sus checkpoints A-C y su Closure Review; está lista para autorización explícita de merge, sin merge automático. SPEC-021 y SPEC-022 permanecen sujetos a autorización separada, y SPEC-022 Development depende de que SPEC-009 sea realmente merged. Ver `docs/epics/EPIC-STOREFRONT-ACADEMIC-PHASE-1.md`, `docs/specs/SPEC-009-cms-landing.md` y `docs/reports/SPEC-009-CLOSURE-REPORT.md`.
