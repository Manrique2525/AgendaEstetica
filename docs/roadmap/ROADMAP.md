...
`EPIC-STOREFRONT-ACADEMIC-PHASE-1` está en estado `DEFINED / COORDINATION ONLY`. Esta agrupación documental consume los roadmap items 09-13 sin renombrarlos, mantiene SPEC-007 pausada y SPEC-008 reservada para Fake WhatsApp, y no autoriza Development. SPEC-009 permanece en Development con Checkpoint C parcial y navegador pendiente. SPEC-021 queda reservado para Appointment Request, sin Definition ni autorización. SPEC-022 tiene Definition + Technical Discovery listas para revisión y depende del cierre/merge de SPEC-009 antes de Development. Ver `docs/epics/EPIC-STOREFRONT-ACADEMIC-PHASE-1.md`, `docs/specs/SPEC-022-academic-phase-1-presentation.md` y `docs/reports/SPEC-022-DISCOVERY-REPORT.md`.
