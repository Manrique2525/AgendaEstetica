...
`SPEC-006 - Public Booking` está en estado `CLOSED / READY FOR MERGE` en `docs/specs/SPEC-006-public-booking.md`. La implementación, aceptación y cierre están aprobados; merge requiere autorización humana separada. SPEC-007 no está autorizado.
