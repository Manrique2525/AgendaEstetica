...
`EPIC-STOREFRONT-ACADEMIC-PHASE-1` está en estado `DEFINED / COORDINATION ONLY`. Esta agrupación documental consume los roadmap items 09-13 sin renombrarlos, mantiene SPEC-007 pausada y SPEC-008 reservada para Fake WhatsApp. SPEC-009 tiene Definition, Technical Discovery, Checkpoint A y Checkpoint B aprobados; la porción técnica de Checkpoint C está implementada, pero la aceptación de navegador real permanece pendiente de verificación humana. Appointment Request y Academic Phase 1 quedan recomendados después del roadmap como SPEC-021 y SPEC-022, sujetos a aprobación separada. Ver `docs/epics/EPIC-STOREFRONT-ACADEMIC-PHASE-1.md`, `docs/specs/SPEC-009-cms-landing.md` y `docs/reports/STOREFRONT-ECOMMERCE-INTEGRATION-AUDIT-REPORT.md`.
