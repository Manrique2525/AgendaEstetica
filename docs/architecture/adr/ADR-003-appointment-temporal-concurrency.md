...
`DRAFT - REQUIRES HUMAN APPROVAL BEFORE IMPLEMENTATION`
...
6. Do not add `schedule_version` unless later evidence shows the lock/revalidation protocol cannot solve stale writes.
